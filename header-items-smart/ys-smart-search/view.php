<?php
/**
 * YS 進階搜尋 Icon — 前台 render。
 *
 * 重用 ys-cart-smart-search 的 renderer：render_icon() 輸出 [data-ys-ss-open]
 * 觸發鈕，彈窗容器與互動 JS 由進階搜尋外掛自管（render 時自動 enqueue）。
 *
...
// fail-soft：進階搜尋外掛不在（或被停用後殘留 placement）→ 前台不輸出。
...
<span
	...
	<?php
	echo \YangSheep\SmartSearch\Frontend\YSSsShortcodes::render_icon(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- 進階搜尋輸出已自含跳脫。
	?>
</span>
